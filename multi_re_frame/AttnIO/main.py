...
import os
from dataset_attnio import MultiReDataset,ToTensor,MultiRe_collate
...
do_predict = '0'
share_subgraph = 0
save_path = f'./models/attnio_bigGraph/share-subgraph_2/batch-{batch_size}/'
...
opt_dataset = {
                    ...
                    "n_hop": n_hop, "n_max":n_max, "max_dialogue_history": 3,'batch':batch_size,'seen_percentage':0.95,
                    'train_unseen_rate':0.95,'max_edge':2000,'prefix_size':1,'do_predict':do_predict,'share_subgraph':share_subgraph}
...
opt_model = {"n_entity_seen": len(data.entity2entityID_seen), 
            ...
            'n_entity_all':len(data.entity2entityID_all),
            "n_relation": len(data.relation2relationID),
            "entity_embeddings_seen": data.entity_embeddings_seen, 
            'entity_embeddings_all':data.entity_embeddings_all,
            ...
            "epoch": 20, "n_hop": n_hop, "n_max": n_max,"model_directory":save_path, 
            "model_name": f'MultiRe', "clip": 5, "self_loop_id": data.relation2relationID["self loop"],'max_edge':2000,'do_predict':do_predict,'share_subgraph':share_subgraph}
