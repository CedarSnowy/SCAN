...
class AttnIODataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        return dialogID,process_samples,state,flag
...
class ToTensor(object):
    ...
    def __call__(self, sample):
        ...
        if state == 'train' or (state =='test' and flag == 1): # AttnIO
        ...
        if state == 'test' and flag == 0:
            ...
            return [dialogue_representation, seed_entities, subgraph, entity_paths,0]
...
def AttnIO_collate(batch): #取数据时进行堆叠
    ...
    for data in batch:
        ...
        dialogID,process_samples,state,flag = data[0],data[1],data[2],data[3]
