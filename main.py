...
if __name__ == '__main__':
    ...
    opt_model = {"n_entity_seen": len(data.entity2entityID_seen), 
                ...
                "epoch": 20, "n_hop": 1, "n_max": 20,"model_directory": "./models/", "model_name": f'MultiRe_', "clip": 5, "self_loop_id": data.relation2relationID["self loop"]}
    ...
    test_dataloader = DataLoader(test_data, batch_size=batch_size,collate_fn=MultiRe_collate)
